...
model_id = st.sidebar.selectbox("Select LLM Model", ["anthropic.claude-3-haiku-20240307-v1:0", "anthropic.claude-3-7-sonnet-20240620-v1:0"])
kb_id = st.sidebar.text_input("Knowledge Base ID", "IGLOKIJP0Y")
